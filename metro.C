...
class metroMap{
    ...
    int djikstras(int source, int d, int path[]){
        source = findStation(source);
        d = findStation(d);
        int parent[count];
        int cost[count];
        bool visited[count];
